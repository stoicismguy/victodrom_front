...
function AnswersItem(props) {
    ...
    return (
        <li className={`${classes.answer_item} ${props.answer.correct ? classes.active_checkbox : ""}`} id={props.answer.index}>
            <input type="checkbox" name="correct" className={classes.correct_input} id="" checked={props.answer.correct ? true : false}
            onClick={(e) => { props.functions.toggle_correct_answer(props.index); }} />
